...
class ArticleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query, Request $request): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'article::admin.article.datatables_action')
            ...
            ->addColumn('slug', function($content){
				return '<a href="'.route('front.article.detail',['slug' => $content->slug]).'" target="_blank" title="Buka Ditab baru">'.$content->slug.' <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>';
			})
            ...
            /* ->addColumn('getKategori', function (ArticleModel $perumahan) {
                return $perumahan->getKategori->title;
            }) */
            /* ->editColumn('kategori', function (ArticleModel $perumahan) {
     ...
     */
    public function query(ArticleModel $model,Request $request): QueryBuilder
    {
        $q =  $model->newQuery();

        ...
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="title" value="{{ $article->title }}"
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="slug" value="{{ $article->slug }}" 
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                        placeholder="URL Artikel" data-id="{{ $article->id}}"/>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 p-1">
                    <textarea name="description"
                        ...
                        placeholder="Konten Artikel" rows="20">{{ $article->description }}</textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
					  <select class="form-control form-select select-custom form-select-sm" name="status">						
						<option value="active"  @selected($article->template == "active")>Active</option>
						<option value="not active"  @selected($article->template == "not active")>Not Active</option>
					  </select>
					</div>
                </div>
            </div>
            ...
            <div class="row">
				...
				<div class="col-sm-12 p-1">
					@if(!empty($article->image))
						<img src="{{ asset(Storage::url($article->image)) }}" class="img img-thumbnail"/>
					@endif
				</div>
            </div>
        </div>
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="meta_title" value="{{ $article->meta_title }}"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="meta_keywords" value="{{ $article->meta_keywords }}"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
            ...
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <textarea name="meta_description"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                        placeholder="Konten Artikel" rows="5">{{ $article->meta_description }}</textarea>
                </div>
            </div>
        </div>
    </div>

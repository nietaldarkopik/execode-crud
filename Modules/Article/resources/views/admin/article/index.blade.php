        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                @can('admin.article.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.article.create') }}" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="slug"]',function(){
        var id = $(this).data("id");
        var slug = $(this).val();
        var url = "{{ route('admin.article.checkSlug')}}";

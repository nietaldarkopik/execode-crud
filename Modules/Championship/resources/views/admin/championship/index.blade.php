    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                @can('admin.championship.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.championship.create') }}" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="slug"]',function(){
        var id = $(this).data("id");
        var slug = $(this).val();
        var url = "{{ route('admin.championship.checkSlug')}}";

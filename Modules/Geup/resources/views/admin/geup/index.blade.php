...
@section('plugins.BootstrapGeup', false)
...
@section('plugins.IonRanggeup', false)
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                @can('admin.geup.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.geup.create') }}" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="slug"]',function(){
        var id = $(this).data("id");
        var slug = $(this).val();
        var url = "{{ route('admin.geup.checkSlug')}}";

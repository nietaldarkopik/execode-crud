...
@section('content')
	...
	@include(env('THEME_PATH').'.partials.geup')
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 col-12">
						@include(env('THEME_PATH').'.partials.widget-geups-horizon')
					</div>
				</div>
			</div>
		</section>
	...
	@include(env('THEME_PATH').'.partials.widget-geup')
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('css/geup.css') }}" />
@endsection
@section('js')
    @parent
    <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    <script src="{{ asset('js/geup.js') }}"></script>
@endsection

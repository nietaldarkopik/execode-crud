{{-- @extends('member_type::layouts.master') --}}
...
@section('content')
	...
	@include(env('THEME_PATH').'.partials.member_type')
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 col-12">
						@include(env('THEME_PATH').'.partials.widget-member_types-horizon')
					</div>
				</div>
			</div>
		</section>
	...
	@include(env('THEME_PATH').'.partials.widget-member_type')
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('css/member_type.css') }}" />
@endsection
@section('js')
    @parent
    <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    <script src="{{ asset('js/member_type.js') }}"></script>
@endsection

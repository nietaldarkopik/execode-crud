...
@section('plugins.BootstrapSetting', false)
...
@section('plugins.IonRangsetting', false)
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                @can('admin.setting.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.setting.create') }}" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="code"]',function(){
        var id = $(this).data("id");
        var code = $(this).val();
        var url = "{{ route('admin.setting.checkCode')}}";

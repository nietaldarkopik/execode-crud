...
class ServicesController extends Controller
{
	...
	function getGeometry_(Request $request)
	{
		$filter = $request->all();
		...
		if(is_array($post_kabupatenkota) and count($post_kabupatenkota) > 0 and is_array($post_point) and count($post_point) > 0){
		...
		$kabupatenkota_layer = $kabupatenkota->map(function($data){
			...
			$properties['iconUrl'] = asset('img/icons/General/landmark.png');
		...
		if(is_array($post_kecamatan) and count($post_kecamatan) > 0 and is_array($post_point) and count($post_point) > 0){
			$perumahan->whereIn('kecamatan_id',$post_kecamatan);
		}
		if(is_array($post_perumahan) and count($post_perumahan) > 0){
		...
		if(is_array($post_permukiman) and count($post_permukiman) > 0){
		...
		$layers = [];
		$layers['kabupatenkota'] = [];
		$layers['kabupatenkota']['point'] = $kabupatenkota_layer;
		$layers['kabupatenkota']['area'] = [];
		$layers['kabupatenkota']['line'] = [];

		$layers['kecamatan']['point'] = $kecamatan_layer;
		$layers['kecamatan']['area'] = [];
		$layers['kecamatan']['line'] = [];

		$layers['kelurahan']['point'] = [];
		$layers['kelurahan']['area'] = [];
		$layers['kelurahan']['line'] = [];

		$layers['perumahan']['point'] = $perumahan_layer;
		$layers['permukiman']['point'] = $permukiman_layer;

		$layers['psu']['point'] = $psu_layer;
		
		$styles = [];
		$styles['kabupatenkota'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kabupatenkota']['area'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kabupatenkota']['line'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kabupatenkota']['point'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bank" viewBox="0 0 16 16">
				<path d="m8 0 6.61 3h.89a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v7a.5.5 0 0 1 .485.38l.5 2a.498.498 0 0 1-.485.62H.5a.498.498 0 0 1-.485-.62l.5-2A.5.5 0 0 1 1 13V6H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 3h.89zM3.777 3h8.447L8 1zM2 6v7h1V6zm2 0v7h2.5V6zm3.5 0v7h1V6zm2 0v7H12V6zM13 6v7h1V6zm2-1V4H1v1zm-.39 9H1.39l-.25 1h13.72z"  stroke="yellow" stroke-width="2" fill="yellow"/>
			</svg>'];

		$styles['kecamatan']['area'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kecamatan']['line'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];

		$styles['kelurahan']['area'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kelurahan']['line'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];

		$styles['perumahan']['point'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-houses-fill" viewBox="0 0 16 16">
				<path d="M7.207 1a1 1 0 0 0-1.414 0L.146 6.646a.5.5 0 0 0 .708.708L1 7.207V12.5A1.5 1.5 0 0 0 2.5 14h.55a2.5 2.5 0 0 1-.05-.5V9.415a1.5 1.5 0 0 1-.56-2.475l5.353-5.354z"/>
				<path d="M8.793 2a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708z"/>
			</svg>'];
		$styles['permukiman']['point'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-houses" viewBox="0 0 16 16">
				<path d="M5.793 1a1 1 0 0 1 1.414 0l.647.646a.5.5 0 1 1-.708.708L6.5 1.707 2 6.207V12.5a.5.5 0 0 0 .5.5.5.5 0 0 1 0 1A1.5 1.5 0 0 1 1 12.5V7.207l-.146.147a.5.5 0 0 1-.708-.708zm3 1a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708zm.707.707L5 7.207V13.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5V7.207z"/>
			</svg>'];

		$styles['psu']['point'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image-fill" viewBox="0 0 16 16">
	...
	function getGeometry(Request $request)
	{
		$filter = $request->all();
		$post_wilayah = $request->wilayah ?? ['*'];
		$post_kabupatenkota = $request->kabupatenkota ?? ['*'];
		...
		$kabupatenkota_layer = $kabupatenkota->map(function($data){
			...
			$properties['style'] = [
				...
				'iconSize' => [64,64],
				'scale' => 0.5,
				'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" stroke="black" class="bi bi-houses-fill" viewBox="0 0 16 16">
					<path d="M7.207 1a1 1 0 0 0-1.414 0L.146 6.646a.5.5 0 0 0 .708.708L1 7.207V12.5A1.5 1.5 0 0 0 2.5 14h.55a2.5 2.5 0 0 1-.05-.5V9.415a1.5 1.5 0 0 1-.56-2.475l5.353-5.354z"/>
					<path d="M8.793 2a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708z"/>
				</svg>',	
			];
		...
		$kecamatan = KecamatanModel::whereIn('regency_id',$kabupatenkota->pluck('id'))->where(function($query) use ($post_kecamatan){
			if(is_array($post_kecamatan) and count($post_kecamatan) > 0 and $post_kecamatan != ['*'] and implode('',$post_kecamatan) != '*')
			{
				$query->whereIn('id',$post_kecamatan);
			}
		})->get();
	...
	function getKecamatanLayers(Request $request)
	{
		...
		$styles = [];
		$styles['kecamatan'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kecamatan']['area'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kecamatan']['line'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => "fa-tree"];
		$styles['kecamatan']['point'] = [ "line_color" => 'random', "fill_color" => 'random', "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bank" viewBox="0 0 16 16">
				<path d="m8 0 6.61 3h.89a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v7a.5.5 0 0 1 .485.38l.5 2a.498.498 0 0 1-.485.62H.5a.498.498 0 0 1-.485-.62l.5-2A.5.5 0 0 1 1 13V6H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 3h.89zM3.777 3h8.447L8 1zM2 6v7h1V6zm2 0v7h2.5V6zm3.5 0v7h1V6zm2 0v7H12V6zM13 6v7h1V6zm2-1V4H1v1zm-.39 9H1.39l-.25 1h13.72z"  stroke="yellow" stroke-width="2" fill="yellow"/>
			</svg>'];
		return response()->json(['layers' => $layers, 'styles' => $styles]);
	}
	...
	function getPermukimanLayers(Request $request)
	{
		...
		$permukiman_layer = $permukiman->map(function($data){
			...
			$properties['style'] = [
				...
				'iconSize' => [64,64],
				'scale' => 0.3,
				'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" stroke="blue" class="bi bi-houses-fill" viewBox="0 0 16 16">
					<path d="M7.207 1a1 1 0 0 0-1.414 0L.146 6.646a.5.5 0 0 0 .708.708L1 7.207V12.5A1.5 1.5 0 0 0 2.5 14h.55a2.5 2.5 0 0 1-.05-.5V9.415a1.5 1.5 0 0 1-.56-2.475l5.353-5.354z"/>
					<path d="M8.793 2a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708z"/>
				</svg>',	
			];
	...
	function getPsuLayers(Request $request)
	{
		...
		$psu_layer = $psu->map(function($data){
			...
			$properties['style'] = [
				...
				'iconSize' => [64,64],
				'scale' => 0.3,
				'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" stroke="yellow" class="bi bi-image-fill" viewBox="0 0 16 16">
					<path d="M.002 3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2zm1 9v1a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062zm5-6.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0"/>
				</svg>',	
			];

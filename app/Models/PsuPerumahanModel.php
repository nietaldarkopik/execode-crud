...
class PsuPerumahanModel extends Model
{
    ...
    protected $fillable = [
        'jenis_perumahan','id_perumahan','id_jenis_psu','id_kategori','id_psu','nama_psu','deskripsi','bast_status','bast_no','bast_file','bast_tanggal','kondisi','latitude','longitude','latlong','photo'
    ];

    
    public function getPerkim(){
        return $this->belongsTo(PerumahanModel::class, 'id_permukiman', 'id');//->select('id','kabkota_id','kecamatan_id','kelurahan_id','latitude','longitude','photo',DB::raw('nama_permukiman as nama_perkim'));
    }

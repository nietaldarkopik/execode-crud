...
<div id="section3" class="container py-5">
  ...
  <form id="filter-form" class="row">
    ...
    <div class="col-md-2">
      <button type="submit" class="btn btn-primary button margin-top-3">Apply</button>
    </div>
    <!-- 
      <div class="col-md-12">
  ...
  <!-- <div class="row">
    <div class="col-12">
      <button class="btn btn-primary button margin-top-3 mb-3 btn-filter-toggle">Filter</button>
    </div>
  </div> -->
        ...
        <table class="table table-striped table-hover table-bordered table-light align-middle">
          <thead class="table-light">
            <tr>
              ...
              <th class="text-center">Nama Pemukiman</th>
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <td><strong><a href="./perumahan-detail.php" class="text-primary">Blizt C'Malaka</a></strong></td>
              <td>Banjarmasin</td>
              <td>Kec. Cimalaka</td>
            ...
            <tr>
              ...
              <td><strong><a href="./perumahan-detail.php" class="text-primary">Blizt C'Malaka 2</a></strong></td>
              <td>Banjarmasin</td>
              <td>Kec. Cimalaka</td>

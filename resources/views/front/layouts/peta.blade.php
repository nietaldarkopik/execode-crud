...
<div class="fs-container">
	<div class="fs-inner-container map-fixed" style="padding-top: 80px;">
		<div id="map-container">
			...
			<div id="legend-map" class="legend-map"></div>
		</div>
	</div>
</div>

<div class="offcanvas offcanvas-start show" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="Id1"
    ...
    <div class="offcanvas-body">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item border-bottom">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body pe-0 py-1 ps-1">
                    ...
                    <div class="accordion-item border-bottom">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse d-none"
        ...
        <button class="btn btn-primary zIndex4 visible position-absolute top-50 start-100 left-auto ms-2 me-auto toggle-offcanvas-start"
...
<div id="popup" class="card ol-popup p-0" hidden="true">
    ...
    <div class="card-body" id="popup-content" style="max-width: 400px; max-height: 300px; overflow: auto;">
...
@section('js')
	...
	// Daftar file GeoJSON yang akan dimuat
		var defaultIconUrl = "{{ asset('listeo/images/marker-icon.png') }}";
		var urlLayers = "{{ route('front.services.getLayer') }}"; 
		var urlGeometry  = "{{ route('front.services.getGeometry') }}"; 
		var urlKabupatenKota  = "{{ route('front.services.getKabupatenKota') }}";
		var urlKabupatenKotaLayers  = "{{ route('front.services.getKabupatenKotaLayers') }}";
		var urlKecamatanLayers  = "{{ route('front.services.getKecamatanLayers') }}";
		var urlKelurahanLayers  = "{{ route('front.services.getKelurahanLayers') }}";
		var urlPerumahanLayers  = "{{ route('front.services.getPerumahanLayers') }}";
		var urlPermukimanLayers  = "{{ route('front.services.getPermukimanLayers') }}";
		var urlPsuLayers  = "{{ route('front.services.getPsuLayers') }}";
		...
		{
			url: urlPermukimanLayers,
			minZoom: 1, // visible at zoom levels above 14
			maxZoom: 20, // visible at zoom levels above 14
			title: 'Permukiman'
		},
		{
			url: urlPerumahanLayers,
			minZoom: 1, // visible at zoom levels above 14
			maxZoom: 40, // visible at zoom levels above 14
			title: 'Perumahan'
		},
		{
			url: urlKecamatanLayers,
			minZoom: 1, // visible at zoom levels above 14
			maxZoom: 20, // visible at zoom levels above 14
			title: 'Kecamatan Titik'
		},
		{
			url: urlKabupatenKotaLayers,
			minZoom: 1, // visible at zoom levels above 14
			maxZoom: 20, // visible at zoom levels above 14
			title: 'Kabupaten/Kota Titik'
		},
		{
			url: asset_url + 'uploads/json/kalsel_kabkota.geojson',
			minZoom: 1, // visible at zoom levels above 14
			maxZoom: 40, // visible at zoom levels above 14
			title: 'Kabupaten/Kota Area',
			projectionSource: 'EPSG:4326',
			projectionLayer: 'EPSG:9518',
		},
	];
	</script>
    ...
    <script src="{{ asset('front/js/peta.lib.js') }}"></script>

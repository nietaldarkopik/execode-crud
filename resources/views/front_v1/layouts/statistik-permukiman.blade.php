...
@section('content')
    ...
    <section id="main-section" class="container-fluid mt-5 pt-5">
        <div id="section-permukiman" class="my-5 py-5 container bg-light">
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <form id="filter-form" class="row p-3 d-flex justify-content-center" action="#">
                                ...
                                <div class="col-md-auto">
                                    <button type="button" class="btn btn-primary mt-1 btn-lg btn-filter"><i
                                            class="fa fa-search"></i> Cari</button>
                                    <button type="button" class="btn btn-warning mt-1 btn-lg btn-reset"><i

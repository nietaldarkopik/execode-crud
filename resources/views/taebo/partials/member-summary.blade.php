									...
									<div class="card-body">
										<div class="text-center">
											...
											<h3 class="m-0 text-gradient text-dark">
												<span id="state1" countTo="{{ DB::table("members")->where("id_member_type",3)->count('id')}}">0</span>
								...
								<div class="card text-dark bg-gray-300">
									<div class="card-body">
										<div class="text-center">
											...
											<h3 class="m-0 text-gradient text-dark">
												<span id="state2" countTo="{{ DB::table("members")->where("id_member_type",2)->count('id')}}">0</span>
								...
								<div class="card text-dark bg-gray-300">
									<div class="card-body">
										<div class="text-center">
											...
											<h3 class="m-0 text-gradient text-dark">
												<span id="state3" countTo="{{ DB::table("members")->where("id_member_type",1)->count('id')}}">0</span>
	...
	<script src="{{ asset('front/js/plugins/countup.min.js')}}"></script>

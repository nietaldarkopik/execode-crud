...
<form action="{{ route('admin.attributepsu.store') }}" method="POST">
    @csrf
    <div class="row">
            ...
            <div class="form-group">
                ...
                <select class="form-select custom-select" name="id_jenis_psu" id="input-id_jenis_psu">
                    ...
                    @foreach (App\Models\JenisPsuModel::get() as $dt)
                        <option value="{{ $dt->id }}" data-kategori="{{ $dt->kategori }}">{{ $dt->title }}
                        </option>
                    @endforeach
                </select>
            </div>
                ...
                <select class="form-select custom-select" name="id_psu" id="input-id_psu">
                    ...
                    @foreach (App\Models\PsuModel::get() as $dt)
                        <option value="{{ $dt->id }}" data-kategori="{{ $dt->kategori }}"
                            data-jenis="{{ $dt->jenis }}">{{ $dt->judul }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="col-sm-12 mb-3">
            <div class="form-group">
                ...
                <input type="text" value="" name="attribute" id="input-attribute" class="form-control"
        ...
        <div class="col-sm-12 mb-3">
            <div class="form-group">
				...
				<textarea type="text" value="" name="options" id="input-options" class="form-control" placeholder="Pisahkan dengan Koma ( , )" rows="5"></textarea>
            </div>
        </div>
        ...
        <div class="col-sm-12 mb-3">
            <div class="form-group">
                ...
                <input type="text" value="" name="keterangan" id="input-keterangan" class="form-control"
                    placeholder="Satuan, Akronim dll">
            </div>
        </div>

...
@push('js')
    <script>
        $('#{{ $modalId ?? "modalId" }}').on('show.bs.modal', event => {
            ...
            $('#{{ $modalId ?? "modalId" }}').find(".modal-body").html('<div class="row"><div class="col-12 p-5 text-center"><img src="{{asset('vendor/adminlte/dist/img/logo-sipsu-kalsel.png')}}" class="img-circle animation__shake" alt="AdminLTE Preloader Image" width="60" height="60" style="animation-iteration-count: infinite; "></div></div>');

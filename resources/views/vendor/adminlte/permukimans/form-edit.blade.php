            ...
            <div class="row mb-1 g-1">
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input type="number" maxlength="4" min="0000" max="{{ date("Y") }}"  pattern="\d{1,5}" name="tahun_siteplan" value="{{ $permukiman?->tahun_siteplan }}"
                                class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input type="number" maxlength="4" min="0000" max="{{ date("Y") }}"  pattern="\d{1,5}" name="tahun_bast" value="{{ $permukiman?->tahun_bast }}"
                                class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"

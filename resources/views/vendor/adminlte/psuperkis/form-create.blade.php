...
<form action="{{ route('admin.psuperki.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-12 p-1">
					<select required="required" name="id_perumahan" id="input-id_perumahan" class="form-select form-custom border-warning border py-0 text-italic rounded-0 form-control-sm w-100">
						<option value="">Pilih Perumahan/Permukiman ...</option>
					</select>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-1 g-1">
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <select required="required" id="input-id_kategori" name="id_kategori" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Kategori">
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <select required="required" id="input-id_jenis_psu" name="id_jenis_psu" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Jenis Psu">
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <select required="required" id="input-id_psu" name="id_psu" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Psu">
								<option value="0">Pilih Jenis Psu ...</option>
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input required="required" type="text" id="input-nama_psu" name="nama_psu" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Nama Psu" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <select required="required" id="input-bast_status" name="bast_status" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Bast Status">
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input type="text" id="input-bast_tanggal" name="bast_tanggal" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm datepicker-single" placeholder="Bast Tanggal" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input type="text" id="input-bast_no" name="bast_no" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="No. BAST" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                ...
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input type="file" id="input-photo" name="photo" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Photo" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-1">
                            <input type="file" id="input-bast_file" name="bast_file" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Bast File" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 border border-secondary mb-1">
                    <div class="row">
                        ...
                        <div class="col-sm-12 p-1">
                            <textarea id="input-deskripsi" name="deskripsi" rows="10" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Deskripsi"></textarea>
                        </div>
                    </div>
                </div>
			</div>
    ...
    <div class="row mb-3">
		...
		<div class="col-xs-12 col-sm-6 border border-secondary mb-1">
			<div class="row">
				...
				<div class="col-sm-7 p-1">
					<input type="text" id="input-x" name="x" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="X" />
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6 border border-secondary mb-1">
			<div class="row">
				...
				<div class="col-sm-7 p-1">
					<input type="text" id="input-y" name="y" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Y" />
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-sm-12 border border-secondary mb-1">
		...
		<div class="col-xs-12 col-sm-6 border border-secondary mb-1">
			<div class="row">
				...
				<div class="col-sm-7 p-1">
					<input type="text" id="input-latitude" name="latitude" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Latitude" />
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-sm-6 border border-secondary mb-1">
			<div class="row">
				...
				<div class="col-sm-7 p-1">
					<input type="text" id="input-longitude" name="longitude" value="" class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm" placeholder="Longitude" />
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-sm-12 border border-secondary mb-1">

                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="m-0 text-gradient text-dark">
                                        <span id="state1"
                                            countTo="<?php echo e(DB::table('members')->where('id_member_type', 3)->count('id')); ?>">0</span>
                        ...
                        <div class="card card-style5">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="m-0 text-gradient text-dark">
                                        <span id="state2"
                                            countTo="<?php echo e(DB::table('members')->where('id_member_type', 2)->count('id')); ?>">0</span>
                        ...
                        <div class="card card-style5">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h3 class="m-0 text-gradient text-dark">
                                        <span id="state3"
                                            countTo="<?php echo e(DB::table('members')->where('id_member_type', 1)->count('id')); ?>">0</span>
...
<?php /**PATH C:\wamp\www\basooki.com\resources\views/basooki/partials/member-summary.blade.php ENDPATH**/ ?>
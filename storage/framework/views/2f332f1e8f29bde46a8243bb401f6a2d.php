        <ul class="navbar-nav navbar-nav-hover ms-auto">
            ...
            $query->orWhere('parent_id', 0);
                ...
                <?php echo $__env->make(env('THEME_PATH').'.partials.nav-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
<?php /**PATH C:\wamp\www\basooki.com\resources\views/basooki/partials/main-menu1.blade.php ENDPATH**/ ?>
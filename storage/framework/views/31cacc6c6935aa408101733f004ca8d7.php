...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div class="card card-accordion-items" data-id="<?php echo e($d->id); ?>" data-code="<?php echo e($d->code); ?>" data-parent_code="<?php echo e($d->parent_code); ?>">
		<div class="card-header pr-0" role="tab" id="sectionHeader<?php echo e($d->id); ?>">
			<h5 class="mb-0 d-flex justify-content-between pr-2">
				<a class="float-start collapsed" data-toggle="collapse" data-parent="#accordionContainer<?php echo e($node_level); ?>" href="#sectionContent<?php echo e($d->id); ?>" aria-expanded="true" aria-controls="sectionContent<?php echo e($d->id); ?>">
					...
					<?php echo e($d->code); ?> - <?php echo e($d->$title); ?>

				</a>
				<div class="card-tools float-end">
					<form method="post" action="<?php echo e(route('admin.unit.destroy',['unit' => $d])); ?>">
						<?php echo csrf_field(); ?>
						<?php echo method_field('delete'); ?>
						<a data-tooltip="tooltip" title="Edit" href="<?php echo e(route('admin.unit.edit',['unit' => $d])); ?>" class="btn btn-sm btn-primary"
		...
		<div id="sectionContent<?php echo e($d->id); ?>" class="collapse in" role="tabpanel" aria-labelledby="sectionHeader<?php echo e($d->id); ?>">
			<div class="card-body pr-0">
				<?php echo $__env->make('vendor.adminlte.partials.widgets.accordion',$subdata, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			</div>
		</div>
	</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
</div><?php /**PATH C:\wamp\www\laravel-feeder-siakad\resources\views/vendor/adminlte/partials/widgets/accordion.blade.php ENDPATH**/ ?>
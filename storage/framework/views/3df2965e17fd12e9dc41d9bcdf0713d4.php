...
<form action="<?php echo e(route('admin.module_manager.update', ['module_manager' => $module_manager])); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
        ...
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="title" value="<?php echo e($module_manager->title); ?>"
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="slug" value="<?php echo e($module_manager->slug); ?>" 
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                        placeholder="URL Module" data-id="<?php echo e($module_manager->id); ?>"/>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 p-1">
                    <textarea name="description"
                        ...
                        placeholder="Konten Module" rows="20"><?php echo e($module_manager->description); ?></textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
					  <select class="form-control form-select select-custom form-select-sm" name="status">						
						<option value="active"  <?php if($module_manager->template == "active"): echo 'selected'; endif; ?>>Active</option>
						<option value="not active"  <?php if($module_manager->template == "not active"): echo 'selected'; endif; ?>>Not Active</option>
					  </select>
					</div>
                </div>
            </div>
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
				...
				<div class="col-sm-12 p-1">
					<?php if(!empty($module_manager->image)): ?>
						<img src="<?php echo e(asset(Storage::url($module_manager->image))); ?>" class="img img-thumbnail"/>
					<?php endif; ?>
				</div>
            </div>
        </div>
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="meta_title" value="<?php echo e($module_manager->meta_title); ?>"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="meta_keywords" value="<?php echo e($module_manager->meta_keywords); ?>"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
            ...
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <textarea name="meta_description"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                        placeholder="Konten Module" rows="5"><?php echo e($module_manager->meta_description); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
</script><?php /**PATH C:\wamp\www\basooki.com\Modules/ModuleManager\resources/views/admin/module_manager/form-edit.blade.php ENDPATH**/ ?>
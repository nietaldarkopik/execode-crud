...
<form action="<?php echo e(route('admin.news.update', ['news' => $news])); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
        ...
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="title" value="<?php echo e($news->title); ?>"
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="slug" value="<?php echo e($news->slug); ?>" 
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                        placeholder="URL Berita" data-id="<?php echo e($news->id); ?>"/>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 p-1">
                    <textarea name="description"
                        ...
                        placeholder="Konten Berita" rows="20"><?php echo e($news->description); ?></textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
					  <select class="form-control form-select select-custom form-select-sm" name="status">						
						<option value="active"  <?php if($news->template == "active"): echo 'selected'; endif; ?>>Active</option>
						<option value="not active"  <?php if($news->template == "not active"): echo 'selected'; endif; ?>>Not Active</option>
					  </select>
					</div>
                </div>
            </div>
            ...
            <div class="row">
				...
				<div class="col-sm-12 p-1">
					<?php if(!empty($news->image)): ?>
						<img src="<?php echo e(asset(Storage::url($news->image))); ?>" class="img img-thumbnail"/>
					<?php endif; ?>
				</div>
            </div>
        </div>
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="meta_title" value="<?php echo e($news->meta_title); ?>"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
    ...
    <div class="row mb-1">
        <div class="col-xs-12 col-sm-12 border">
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <input required="required" type="text" name="meta_keywords" value="<?php echo e($news->meta_keywords); ?>"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
            ...
            <div class="row">
                ...
                <div class="col-sm-8 p-1">
                    <textarea name="meta_description"
                        class="form-control border-warning border py-0 text-italic rounded-0 form-control-sm"
                        placeholder="Konten Berita" rows="5"><?php echo e($news->meta_description); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
</script><?php /**PATH C:\wamp\www\taebo\Modules/News\resources/views/admin/news/form-edit.blade.php ENDPATH**/ ?>
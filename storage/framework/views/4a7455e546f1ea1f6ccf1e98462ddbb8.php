...
<form action="<?php echo e(route('admin.ujiankt.update', ['ujiankt' => $ujiankt])); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12 ">
            <div class="form-group">
                ...
                <input type="text" required="required" class="form-control" name="title" id="title" value="<?php echo e($ujiankt->title); ?>"
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12 ">
            <div class="form-group">
                ...
                <input type="text" required="required" class="form-control" name="slug" id="slug" value="<?php echo e($ujiankt->slug); ?>" aria-describedby="namaHelpId" placeholder="URL UKT">
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="organizer" value="<?php echo e($ujiankt->organizer); ?>"
                    class="form-control"
    ...
    <div class="row mb-2">
        <div class="col-xs-6 col-sm-6">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="reg_open" value="<?php echo e($ujiankt->reg_open); ?>"
        ...
        <div class="col-xs-6 col-sm-6">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="reg_close" value="<?php echo e($ujiankt->reg_close); ?>"
                    class="form-control input-datepicker"
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="place" value="<?php echo e($ujiankt->place); ?>"
                    class="form-control"
                    placeholder="Tempat" />
            </div>
        </div>
    ...
    <div class="row mb-2">
        <div class="col-xs-6 col-sm-6">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="event_start" value="<?php echo e($ujiankt->event_start); ?>"
                    class="form-control input-datepicker"
                    placeholder="Mulai UKT" />
            </div>
		</div>
        <div class="col-xs-6 col-sm-6">
            <div class="form-group mb-0">
                <label class="mb-0" for="event_end">Akhir UKT</label>
                <input required="required" type="text" name="event_end" value="<?php echo e($ujiankt->event_end); ?>"
                    class="form-control input-datepicker"
                    placeholder="Akhir UKT" />
            </div>
        </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <input required="required" type="number" name="price" value="<?php echo e($ujiankt->price); ?>"
                    class="form-control"
                    placeholder="Biaya" />
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <textarea name="description"
                    ...
                    placeholder="Konten UKT" rows="20"><?php echo e($ujiankt->description); ?></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
				...
				<select class="form-control form-select select-custom form-select-sm" name="status">						
				  <option value="active" <?php if($ujiankt->status == "active"): echo 'selected'; endif; ?>>Active</option>
				  <option value="not active" <?php if($ujiankt->status == "not active"): echo 'selected'; endif; ?>>Not Active</option>
				</select>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="meta_title" value="<?php echo e($ujiankt->meta_title); ?>"
                    class="form-control"
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <input required="required" type="text" name="meta_keywords" value="<?php echo e($ujiankt->meta_keywords); ?>"
                    class="form-control"
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <textarea name="meta_description" class="form-control"
                    placeholder="Meta Description" rows="5"><?php echo e($ujiankt->meta_description); ?></textarea>
            </div>
        </div>
    </div>
...
</script><?php /**PATH C:\wamp\www\taebo\Modules/UjianKt\resources/views/admin/ujiankt/form-edit.blade.php ENDPATH**/ ?>
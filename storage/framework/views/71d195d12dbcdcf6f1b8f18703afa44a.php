...
<?php $__env->startPush('js'); ?>
    <script>
        $('#<?php echo e($modalId ?? "modalId"); ?>').on('show.bs.modal', event => {
            ...
            $('#<?php echo e($modalId ?? "modalId"); ?>').find(".modal-body").html('<div class="row"><div class="col-12 p-5 text-center"><img src="http://localhost/si-psu-new/public/vendor/adminlte/dist/img/logo-sipsu-kalsel.png" class="img-circle animation__shake" alt="AdminLTE Preloader Image" width="60" height="60" style="animation-iteration-count: infinite; "></div></div>');
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp\www\laravel-feeder-siakad\resources\views/vendor/adminlte/partials/modal/modal-default.blade.php ENDPATH**/ ?>
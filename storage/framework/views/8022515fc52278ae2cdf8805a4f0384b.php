...
<form action="<?php echo e(route('admin.ujiankt.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12 ">
            <div class="form-group">
                <label class="mb-0" for="name">URL UKT</label>
                <input type="text" required="required" class="form-control" name="slug" id="name"
                    aria-describedby="namaHelpId" placeholder="URL UKT">
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <textarea name="description"
                    ...
                    placeholder="Konten UKT" rows="20"></textarea>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp\www\taebo\Modules/UjianKt\resources/views/admin/ujiankt/form-create.blade.php ENDPATH**/ ?>
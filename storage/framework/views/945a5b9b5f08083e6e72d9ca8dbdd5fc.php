...
<?php $__env->startSection('plugins.BootstrapGeup', false); ?>
...
<?php $__env->startSection('plugins.IonRanggeup', false); ?>
...
<?php $__env->startSection('title', 'Data Geup'); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.geup.create')): ?>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('admin.geup.create')); ?>" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="slug"]',function(){
        var id = $(this).data("id");
        var slug = $(this).val();
        var url = "<?php echo e(route('admin.geup.checkSlug')); ?>";
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\taebo\Modules/Geup\resources/views/admin/geup/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('plugins.BootstrapSetting', false); ?>
...
<?php $__env->startSection('plugins.IonRangsetting', false); ?>
...
<?php $__env->startSection('title', 'Data Setting'); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.setting.create')): ?>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('admin.setting.create')); ?>" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	function setValueType(){
		...
		$(".input-value").find(":input").prop("disabled",true);
		$(".input-value.input-value-"+type).removeClass("d-none");
		$(".input-value.input-value-"+type).find(":input").prop("disabled",false);
	}
	...
	$("body").on("blur",'[name="code"]',function(){
        var id = $(this).data("id");
        var code = $(this).val();
        var url = "<?php echo e(route('admin.setting.checkCode')); ?>";
        ...
        $.ajax({
            ...
            success:function(msg){
                $(".response-check-code").html('<div class="text-success">'+msg.message+'</div>');
            },
			error: function(msg,xhr,c){
				var responseJSON = msg.responseJSON;
				$(".response-check-code").html('<div class="text-danger">'+responseJSON.message+'</div>');
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\basooki.com\Modules/Setting\resources/views/admin/setting/index.blade.php ENDPATH**/ ?>
        ...
        <div class="container">
                    ...
                    <div class="card card-profile mt-4">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                <a href="<?php echo e(route('front.member.detail',['slug' => $member->id.'-'.Str::slug($member->nama)])); ?>">
                                    <div class="p-3 pe-md-0">
										<?php if(!empty($member->photo)): ?>
                                        <img class="w-100 border-radius-md shadow-lg" src="<?php echo e(asset(Storage::url($member->photo))); ?>" alt="Anggota Taebo - <?php echo e($member->nama); ?>">
										<?php else: ?>
                                        <img class="w-100 border-radius-md shadow-lg" src="<?php echo e(asset('front/img/logo-taebo.jpeg')); ?>" alt="Anggota Taebo - <?php echo e($member->nama); ?>">
										<?php endif; ?>
                                    </div>
                                </a>
                            </div>
			...
			<div class="row">
                <div class="col-lg-12 col-12 text-center">
					<a href="<?php echo e(route('front.member.detail')); ?>" class="btn btn-lg btn-danger btn-lg push-end align-items-center justify-content-center d-flex col-md-3 mx-auto">
...
<?php /**PATH C:\wamp\www\basooki.com\resources\views/taebo/partials/widget-anggota.blade.php ENDPATH**/ ?>
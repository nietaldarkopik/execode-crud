...
<form action="<?php echo e(route('admin.article.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12 ">
            <div class="form-group">
                <label class="mb-0" for="name">URL Artikel</label>
                <input type="text" required="required" class="form-control" name="slug" id="name"
                    aria-describedby="namaHelpId" placeholder="URL Artikel">
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                <label class="mb-0" for="description">Konten Artikel</label>
                <textarea name="description"
                    class="form-control text-italic rounded-0 form-control-sm summernote"
                    placeholder="Konten Artikel" rows="20"></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                ...
                <textarea name="meta_description" class="form-control text-italic rounded-0 form-control-sm"
                    placeholder="Konten Artikel" rows="5"></textarea>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp\www\taebo\Modules/Article\resources/views/admin/article/form-create.blade.php ENDPATH**/ ?>
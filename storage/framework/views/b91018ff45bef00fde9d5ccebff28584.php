...
<?php $__env->startSection('title', 'Data Halaman'); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.halaman.create')): ?>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('admin.halaman.create')); ?>" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="slug"]',function(){
        var id = $(this).data("id");
        var slug = $(this).val();
        var url = "<?php echo e(route('admin.halaman.checkSlug')); ?>";
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\basooki.com\resources\views/vendor/adminlte/halamans/index.blade.php ENDPATH**/ ?>
...
<form action="<?php echo e(route('admin.news.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12 ">
            <div class="form-group">
                <label class="mb-0" for="name">URL Berita</label>
                <input type="text" required="required" class="form-control" name="slug" id="name"
                    aria-describedby="namaHelpId" placeholder="URL Berita">
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="form-group mb-0">
                <label class="mb-0" for="description">Konten Berita</label>
                <textarea name="description"
                    class="form-control text-italic rounded-0 form-control-sm summernote"
                    placeholder="Konten Berita" rows="20"></textarea>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp\www\taebo\Modules/News\resources/views/admin/news/form-create.blade.php ENDPATH**/ ?>
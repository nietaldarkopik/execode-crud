...
<head>
    ...
    <?php if(!config('adminlte.enabled_laravel_mix')): ?>
        ...
        <?php if(config('adminlte.google_fonts.allowed', true)): ?>
			...
			<?php endif; ?>
			<?php else: ?>
			<link rel="stylesheet" href="<?php echo e(mix(config('adminlte.laravel_mix_css_path', 'build/assets/css/app.css'))); ?>">
			<?php endif; ?>
    ...
    <?php else: ?>
        <script src="<?php echo e(mix(config('adminlte.laravel_mix_js_path', 'js/app.js'))); ?>" type="module"></script>
    <?php endif; ?>
</head>
...
<?php /**PATH C:\wamp\www\laravel-feeder-siakad\resources\views/vendor/adminlte/master.blade.php ENDPATH**/ ?>
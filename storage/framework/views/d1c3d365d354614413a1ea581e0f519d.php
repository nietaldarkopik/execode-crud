...
<?php $__env->startSection('plugins.BootstrapMemberType', false); ?>
...
<?php $__env->startSection('plugins.IonRangmember_type', false); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.member_type.create')): ?>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('admin.member_type.create')); ?>" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tambah Data">
...
<script>
	...
	$("body").on("blur",'[name="slug"]',function(){
        var id = $(this).data("id");
        var slug = $(this).val();
        var url = "<?php echo e(route('admin.member_type.checkSlug')); ?>";
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\taebo\Modules/MemberType\resources/views/admin/member_type/index.blade.php ENDPATH**/ ?>
                                ...
                                <td>
									<form method="post" action="<?php echo e(route('admin.users.destroy', $user->id)); ?>">
										...
										<button class="btn btn-sm btn-danger" href="<?php echo e(route('admin.users.destroy', $user->id)); ?>"
											data-toggle="tooltip" data-placement="bottom" data-html="false"
											data-title="Hapus Data" onclick="return confirm('Apakah yakin ingin menghapus user ini?')">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\taebo\resources\views/vendor/adminlte/users/index.blade.php ENDPATH**/ ?>
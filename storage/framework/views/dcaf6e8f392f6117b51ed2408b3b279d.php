...
<div class="container mt-5">
        ...
        <?php $__currentLoopData = $newss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-sm-6">
                <div class="card card-style5">
                    ...
                    <div class="card-body">
                        <h5>
                            <a href="<?php echo e(route('front.news.detail', ['slug' => $news?->slug])); ?>"
                                class="text-dark oswald-bold font-weight-bold"><?php echo e($news->title); ?></a>
                        </h5>
    ...
    <div class="row">
        <div class="col-lg-12 col-12 text-center pt-3">
            <a href="<?php echo e(route('front.news.detail')); ?>"
...
<?php /**PATH C:\wamp\www\basooki.com\resources\views/basooki/partials/widget-news.blade.php ENDPATH**/ ?>